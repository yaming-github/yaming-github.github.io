  ...
  return (<>
    <div style={{display: "flex", justifyContent: "center", marginTop: '30px'}}>
      <Avatar src={avatar}
              ...
              draggable={"false"}/>
      <Button style={{
        border: "none", marginLeft: '20px', marginTop: 'auto', marginBottom: "auto",
      }}
              href={"/#/cv"}
              size={"large"}
    ...
    <Timeline
      style={{
        paddingTop: '20px', backgroundColor: 'rgba(255,182,193,0.07)', backgroundClip: 'padding-box'
      }}
      mode={'left'}
      items={[{
        label: (<>
        ...
        label: (<>
          ...
          <ul style={style}>
            ...
            <li>Utilized the <b>Hadoop</b> file API to efficiently parse records from the <b>OpenStreetMap</b> PBF
              file, enabling extraction of OSM entities for subsequent <b>Big Data Processing Pipelines</b> on <b>AWS
                EMR</b>.
            </li>
    ...
    <Timeline
      style={{
        paddingTop: '10px', backgroundColor: 'rgba(255,182,193,0.09)', backgroundClip: 'padding-box'
      }}
      mode={'alternate'}
      items={[{
        label: (<>
    ...
    <Timeline
      style={{
        paddingTop: '10px', backgroundColor: 'rgba(255,182,193,0.07)', backgroundClip: 'padding-box'
      }}
      mode={'alternate'}
      items={[{
        label: (<>
        ...
        label: (<>
          ...
          <a style={{
            ...
            marginLeft: '20pc', color: "black", textDecoration: "underline",
          }}
